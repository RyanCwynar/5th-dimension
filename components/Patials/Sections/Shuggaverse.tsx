          ...
          <AnimateWrapper yOffset={-70} delayOrder={1.5} animateType={AnimateType.FADEIN}>
            ...
            <Paragraph className="mt-6 text-4 xl:text-[26px] xl:leading-[33.07px] text-primary">
               <span className="font-RedHatBold">
                  The 5th Dimension metaverse - &nbsp;
              </span>  will contain many different communities, or worlds. Each world is dedicated to a different area of arts and entertainment. There will be worlds for fine art, music, comic books, film, and more – even discovering new genres that are possible because of NFT technology.
            </Paragraph>
            ...
            <Paragraph className="mt-6 text-4 xl:text-[26px] xl:leading-[33.07px] text-primary">
              ...
              &nbsp; The 5D Art World is the community for artists to network, collaborate, learn, get funding, and more. We will start things off with an ambitious project bringing together 500 artists to release an NFT collection of 1000 unique art NFTs. Artists will be chosen from the 5D Owlie community.             </Paragraph>
              <Paragraph className="mt-6 text-4 xl:text-[26px] xl:leading-[33.07px] text-primary">
